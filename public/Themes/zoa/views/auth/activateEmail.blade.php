      ...
      <div class="row">
        ...
        <div class="col-md-7 col-lg-5 mx-auto">
          <div class="item_group card card-shadow border-0 radius-5">
            <form method="POST" action="{{ route('user-profile-login-post', ['profile' => $user->username, 'type' => 'activate']) }}" class="row">
                @csrf
              <div class="col-12">
                <div class="title_sign">
                  <h2>{{ __('Activate account') }}</h2>
                  <p>{{ __('Please enter the activation code sent to your email') }}</p>
                </div>
              </div>
